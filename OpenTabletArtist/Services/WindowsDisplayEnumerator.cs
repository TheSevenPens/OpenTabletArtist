...
/// <summary>
/// Windows <see cref="IDisplayEnumerator"/>: enumerates connected monitors in virtual-desktop pixels
/// (geometry via the GDI monitor APIs) and, best-effort, their friendly names (via the DisplayConfig
/// API — matching what Windows Display Settings shows). Friendly-name lookup is fully fault-tolerant:
