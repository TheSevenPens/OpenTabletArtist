...
/// <summary>
/// Experimental frosted-glass (acrylic) tuning for the cards. Tint + material opacity are persisted
/// via <see cref="AppSettings"/> and exposed on the Theme page.
/// </summary>
public static class AcrylicSettings
{
    ...
    // Card opacity is stored PER SKIN (keyed by the skin name — "Sakura", "DarkSakura",
