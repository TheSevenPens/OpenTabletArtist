...
- **About** — The first tab: a read-out of the connected tablet's specs, split into two cards — **Specifications** (name, active area in mm & inches, its diagonal, and aspect ratio) and **Features** (digitizer resolution in LP/mm and LPI, pressure levels, pen/express/mouse button counts, and touch ring/strip/touch support).
