...
public static class PressureCurveProfile
{
    ...
    public const string FilterTypeName = "OtdArtist.Dynamics.DynamicsFilter";
    ...
    public const string LegacyFilterTypeName = "OtdArtist.PressureCurve.PressureCurveFilter";
