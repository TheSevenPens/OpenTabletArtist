...
{
    [Theory]
    [InlineData("OtdWindowsHelper.Dynamics", "OtdWindowsHelper.Dynamics.DynamicsFilter", true)]
    [InlineData("VoiDPlugins", "VoiDPlugins.OutputMode.WinInkAbsoluteMode", true)]
    [InlineData("OtdWindowsHelper.Dynamics", "OtdWindowsHelper.Dynamics", true)]   // exact
    [InlineData("OtdWindowsHelper.Dynamics", "OtdWindowsHelper.DynamicsX.Foo", false)] // not a namespace boundary
    [InlineData("OtdWindowsHelper.Dynamics", "Other.Plugin.Type", false)]
